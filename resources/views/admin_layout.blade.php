...
<script src="https://kit.fontawesome.com/961912730f.js" crossorigin="anonymous"></script>
</head>
<body >
...
<div class="top-nav clearfix" >
    ...
    <ul class="nav pull-right top-menu">
         <a style="color:white;margin-left:10px;margin-top:24px;" href="{{URL::to('/trang-chu')}}"><i class="fa-solid fa-house-user"></i>Trang Chủ</a>
...
<!-- footer -->
        <div class="footer" style="background: #626262">
            ...
            <p>Copyright @ 2022 . University of Infomation Technology. Design by <a style="color:red;" href="https://www.facebook.com/nqk.dev">NQK - DEV</a></p>
            </div>
        </div>
<!-- / footer -->
</section>
